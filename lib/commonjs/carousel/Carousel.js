...
class Carousel extends _react.default.Component {
  ...
  render() {
    ...
    return this._needsScrollView() || !_reactNative.Animated.FlatList ? /*#__PURE__*/_react.default.createElement(ScrollViewComponent, _extends({
      ref: c => {
        this._carouselRef = c;
      }
    }, props), this._getCustomData().map((item, index) => {
    ...
    _react.default.createElement(_reactNative.Animated.FlatList, _extends({
      ref: c => {
        this._carouselRef = c;
      }
    }, props));
